  ...
  return (
    <>
      <Routes>
        ...
        <Route
          path="/domiciliation/1-an-entreprise"
          element={<Domiciliation1AnEntreprise />}
        />
        <Route
          path="/domiciliation/6-mois-entreprise"
          element={<Domiciliation6MoisEntreprise />}
        />
        <Route
          path="/domiciliation/3-mois-entreprise"
          element={<Domiciliation3MoisEntreprise />}
        />
        <Route
          path="/domiciliation/6-mois-micro-entreprise"
          element={<Domiciliation6MoisMicroEntreprise />}
        />
        <Route
          path="/domiciliation/3-mois-micro-entreprise"
          element={<Domiciliation3MoisMicroEntreprise />}
        />
        <Route
          path="/domiciliation/pack-domicilie"
          element={<PackDomicilie />}
        />
        <Route path="/services-admin" element={<ServicesAdmin />} />
        <Route
          path="/services-complementaires"
          element={<ServicesComplementaires />}
        />
        ...
        <Route
          path="/communication/strategie"
          element={<CommunicationStrategie />}
        />
        <Route
          path="/communication/site-internet"
          element={<CommunicationSiteInternet />}
        />
        <Route path="/communication/print" element={<CommunicationPrint />} />
        <Route path="/communication/photos" element={<CommunicationPhotos />} />
        <Route
          path="/communication/creations"
          element={<CommunicationCreations />}
        />
        <Route
          path="/communication/community-management"
          element={<CommunicationCommunityManagement />}
        />
        <Route
