...
const PRODUCTS = [
  ...
  {
    id: "scan-courrier",
    title: "Scan courrier (3 mois)",
    price: 18,
    category: "domiciliation",
    link: "/service/scan-courrier",
  },
  {
    id: "creation-courrier",
    title: "Création courrier administratif ou commercial",
    price: 30,
    category: "admin",
    link: "/service/creation-courrier",
  },
...
const RelatedProducts = ({ currentId, currentCategory }) => {
  ...
  const relatedLimited = related.slice(0, 3);
