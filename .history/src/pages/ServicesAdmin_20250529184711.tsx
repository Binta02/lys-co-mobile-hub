  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <p className="max-w-3xl mx-auto mt-8 mb-12 text-lg text-gray-700 text-center leading-relaxed">
          <strong>ASSISTANAT</strong>
          <br />
          <br />
          Imaginez <strong>déléguer</strong> toute la{" "}
          <strong>gestion administrative</strong>,<strong>comptable</strong> et{" "}
          <strong>commerciale</strong> à des <strong>assistants experts</strong>
          , vous permettant ainsi de vous recentrer sur l’
          <strong>essentiel</strong>
          de votre activité. Nos partenaires <strong>secrétaires</strong>{" "}
          prennent en charge toutes vos <strong>obligations</strong>, de la{" "}
          ...
          <strong>liberté</strong> de vous consacrer pleinement à ce que vous
          faites de mieux, tout en ayant la{" "}
          <strong>tranquillité d’esprit</strong> que les aspects les plus{" "}
          <strong>fastidieux</strong> de votre entreprise sont{" "}
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Déléguez toute la gestion administrative, comptable et
                  commerciale à nos assistants experts. Libérez-vous des tâches
                  chronophages pour vous concentrer sur le cœur de votre
                  activité.
                </p>
              </div>
