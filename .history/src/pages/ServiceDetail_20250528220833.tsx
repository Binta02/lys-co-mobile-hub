...
import "./calendar-custom.css"; // <-- tu mets ici tes styles custom
                ...
                <div className="mt-8 space-y-4 p-5 border border-gray-200 rounded-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    <DatePicker
                      ...
                      minDate={new Date()}
                      className="w-full p-3 border rounded-xl shadow-md bg-white focus:outline-none focus:ring-2 focus:ring-lysco-turquoise"
                    />
                  </div>
