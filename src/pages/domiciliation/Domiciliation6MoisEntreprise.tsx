...
const Domiciliation6MoisEntreprise = () => {
  ...
  const handleAddToCart = () => {
    ...
    toast({
      ...
      description: "Domiciliation 6 mois – Entreprise a été ajouté à votre panier.",
    });
  };
        ...
        <div className="container mx-auto px-4">
          <Breadcrumb className="mb-6">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink to="">Domiciliation 6 mois – Entreprise</BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              ...
              <h1 className="text-3xl font-bold">Domiciliation 6 mois – Entreprise</h1>
              <div>
                <div className="flex items-center">
                  <span className="text-lg line-through text-gray-500 mr-2">216,00 €</span>
                  <span className="text-2xl font-semibold text-lysco-turquoise">162,00 €</span>
                </div>
                <p className="text-sm text-gray-500">Hors taxes</p>
              </div>

              <div className="prose max-w-none">
                <p>Notre offre spéciale de domiciliation d'entreprise vous permet de bénéficier d'une réduction exceptionnelle sur les frais de domiciliation pour les 6 premiers mois. Jusqu'au 30 Septembre, vous pouvez profiter d'une réduction de 50% sur les 3 premiers mois de domiciliation lorsque vous vous engagez pour une période de 6 mois. C'est une occasion à ne pas manquer pour économiser sur les frais tout en bénéficiant d'une adresse professionnelle prestigieuse pour votre entreprise.</p>
              </div>
