...
// import { ServiceData, ReservationPrices, ReservationInsert } from '@/types/database'
...
//   const dateStart = `${dateReservation}T${hour}:00:00+00:00`
//   const endHour = String(Number(hour.split(':')[0]) + 1).padStart(2, '0')
//   const dateEnd = `${dateReservation}T${endHour}:00:00+00:00`
//   const rangeToCheck = `[${dateStart},${dateEnd})`

//   return reservedPeriods.some(p => {
//     return supabase
//       .rpc('tstzrange_overlaps', { range1: p, range2: rangeToCheck })
//   })
// }
