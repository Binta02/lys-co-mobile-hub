...
const Contact: React.FC = () => {
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      const res = await fetch('https://mon-backend-node.vercel.app/api/send-contact', {
        method: 'POST',
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-r from-lysco-turquoise/10 to-lysco-pink/10 py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-600">Notre équipe est à votre disposition pour répondre à vos questions.</p>
          </div>
        </section>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:contact@lys-and-co.com" className="text-gray-600 hover:text-lysco-turquoise">
              ...
              <CardContent className="p-6">
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea {...field} placeholder="Votre message..." className="min-h-[150px]" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <Button type="submit" className="w-full bg-lysco-turquoise hover:bg-opacity-90" disabled={form.formState.isSubmitting}>
