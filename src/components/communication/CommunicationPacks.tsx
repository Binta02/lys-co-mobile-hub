  ...
  return (
    <section className="py-16 px-4 bg-white">
      <div className="container mx-auto">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">Nos Packs de Communication</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="border p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mb-4">À partir de 1500€</p>
          </div>
          {/* Pack Moyen */}
          <div className="border p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4">Pack Moyen</h3>
            <ul className="list-disc list-inside text-gray-600 mb-4">
              <li>Création de logo</li>
              <li>Identité visuelle</li>
              <li>1 création de carte de visite (hors impression)</li>
            ...
            <p className="text-gray-600 mb-4">À partir de 2000€</p>
          </div>
          {/* Pack Pro */}
          <div className="border p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4">Pack Pro</h3>
            <ul className="list-disc list-inside text-gray-600 mb-4">
              <li>Création de logo</li>
              <li>Identité visuelle</li>
              <li>1 flyer recto</li>
            ...
            <p className="text-gray-600 mb-4">À partir de 2600€</p>
          </div>
        </div>
